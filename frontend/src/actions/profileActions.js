...
export const requestPasswordReset = (email) => (dispatch) => {
  axios.post("/api/reset_password_request", { email: email }).then((res) => {
...
*/
export const createNewPassword = (userPK, newPassword) => (dispatch) => {
  console.log(userPK);
  axios.post("/api/create_new_password", {
    user_pk: userPK,
    new_password: newPassword,
  }).then(res =>{
    console.log('wyslano zadanie');
  });
};
